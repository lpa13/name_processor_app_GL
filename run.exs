...
# Certifica-se de que os módulos NameProcessor e RomanNumerals são carregados
Code.require_file("lib/name_processor.ex")
Code.require_file("lib/roman_numerals.ex")
